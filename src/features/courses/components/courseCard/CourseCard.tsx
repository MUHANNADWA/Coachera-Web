    ...
    <article
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3 z-10">
          <span className="text-xs font-semibold text-white bg-primary backdrop-blur-sm px-2 py-1 rounded-md">
        ...
        {course.price === 0 && (
          <div className="absolute bottom-3 left-3 z-10">
            <span className="text-xs font-bold text-primary bg-white/90 border border-primary/20 px-2 py-1 rounded-md">
              Free
            </span>
          </div>
        )}
      ...
      <div className="p-5 space-y-3">
        {/* Title */}
        <h3
          className="font-bold text-xl text-gray-900 line-clamp-2 group-hover:text-primary transition-colors duration-200"
          title={course.title}>
          {course.title}
        </h3>
