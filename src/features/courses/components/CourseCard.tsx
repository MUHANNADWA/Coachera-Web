...
export default function CourseCard({ course }: CourseCardProps) {
  return (
    <Link
      ...
      className="bg-white rounded-2xl relative shadow-sm hover:shadow-lg transition-all hover:scale-105 duration-300 w-full overflow-hidden">
      <img
      ...
      <div>
        <span className="text-sm absolute  top-2 right-2 text-primary bg-primary-light border-primary border-1 p-2 rounded-2xl">
          {course.categories?.[0]}
        </span>
      </div>
    </Link>
