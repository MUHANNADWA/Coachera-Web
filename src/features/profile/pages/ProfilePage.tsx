...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      {/* Profile Header */}
      <section className="consect p-6 flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-6 mb-10">
        <img
          src={PROFILE_IMAGE}
        ...
        />
        <div className="flex-1 text-center md:text-left dark:text-white ">
      ...
      <section className="mb-16" id="wishlist">
        <h2 className="text-2xl font-bold mb-6 dark:text-white">Favorites</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {/* Career CTA */}
      <section className="consect px-8 py-12 text-center">
        <p className="text-primary font-semibold tracking-wide uppercase text-sm mb-2">
          Course Categories
        </p>
        <h1 className="text-4xl md:text-5xl font-semibold mb-4 dark:text-white">
