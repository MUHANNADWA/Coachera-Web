...
const Message = ({
  ...
  const variantStyles: Record<MessageVariant, string> = {
    ...
    success: "bg-green-50 text-green-800 border-green-300 dark:bg-green-900/30 dark:text-green-900 dark:border-green-800",
    warning: "bg-yellow-50 text-yellow-800 border-yellow-300 dark:bg-yellow-900/30 dark:text-yellow-900 dark:border-yellow-800",
    danger: "bg-red-50 text-red-800 border-red-300 dark:bg-red-900/30 dark:text-red-900 dark:border-red-800",
